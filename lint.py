...
if __name__ == "__main__":
    ...
    parser.add_argument("--precommit", action="store_true", help="Run in precommit mode", default=False)
    parser.add_argument("--apply", action="store_true", help="Apply fixes if possible", default=False)
